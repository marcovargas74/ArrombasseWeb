...
It provides a template function you can use:
	src_simple_recent_comments(arg1, arg2)
Arguments explanation:
	arg1 (numeric): The number of comments to return. Default: 7
	arg2 (numeric): The comment excerpt length. Default: 75
...
/* Changelog
* Feb 2007
- Modified code to include it into HemingwayEx plugin. A nice and simple plugin
...
function src_simple_recent_comments($src_count=7, $src_length=75) {
	global $wpdb;
