...
<?php if ($comments) : ?>
	...
	<?php $counter=1; foreach ($comments as $comment) : ?>
		<li id="comment-<?php comment_ID() ?>">
			<div class="counter right"><?php echo $counter; $counter++; ?></div>
			<cite>
				<span class="author"><?php comment_author_link() ?></span>
				<span class="date"><?php comment_date( $hemingwayEx->date_format() . '.y' ) ?> / <?php comment_date('ga') ?></span>
			</cite>
