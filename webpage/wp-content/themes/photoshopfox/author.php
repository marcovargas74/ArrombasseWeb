...
<?php the_excerpt(); ?>
<p><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>">Click here to read more from <?php the_author(); ?></a></p>
</div>
...
<h2>Sorry The Author You Are Looking For Had Been Deleted</h2>
