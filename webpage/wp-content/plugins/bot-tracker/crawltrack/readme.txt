...
You will find more details information on the official website : http://www.crawltrack.fr
...
If you are using the second tag (the biggest one with http request) from a version before the 2.0.0, you need to replace the tag on your page
to be able to use that version.

Once Crawltrack install, don't forget to add your site to the Crawltrack users directory:
http://www.crawltrack.fr/user-list/english.html
...
Vous trouverez des informations plus détaillées sur le site officiel: http://www.crawltrack.fr/fr
...
Si vous utilisiez le deuxième tag (le plus long, avec la requète http) d'une version avant la 2.0.0, il faut remplacer
...
http://www.crawltrack.fr/user-list/french.html