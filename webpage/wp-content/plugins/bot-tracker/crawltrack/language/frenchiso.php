...
//modified in 1.5.0
$language['login_finish']="L'installation est terminée.N'oubliez pas de mettre le tag (disponible page outils) sur les pages de votre site.";
//access
...
$language['maxmind']="Cette recherche a été faites en utilisant la base de données GeoLite crée par Maxmind disponible à l'adresse suivante:";
...
$language['100_lines']="Affichage limité à 100 lignes.";
...
$language['lastmonth']="Le mois précédent à la même date";
//2.2.0
$language['admin_database']="Voir la taille de la base de données";
$language['table_name']="Nom de la table";
$language['nbr_of_data']="Nombre d'enregistrements";
