...
<li>Wenn Sie ein Content Management Script nutzen (Forum, Blog, Galerie, CMS, etc.), schauen Sie sich www.crawltrack.fr/doccms.php an, um die Beste Lösung zum Einbau des Codes zu erhalten.</li>
...
$language['100_visit_per-crawler']="Besucherdetails (die Anzeige ist auf 100 Zeilen beschränkt).";
...
$language['no_access2']="Zugriff auf www.CrawlTrack.info nicht möglich, versuchen Sie es später noch einmal.";
...
$language['ip_suppress_no_ok']="Während der L&ouml;schung ist ein Problem aufgetreten. Bitte versuchen Sie es noch einmal.";
...
$language['ip_suppress_validation3']="Wenn Sie Visits von dieser IP unterdr&uuml;cken wollen, ergänzen Sie folgende Zeilen in Ihrer .htaccess Datei:";
...
//1.7.0
$language['step1_install_no_ok4']="Während des füllens der IP Tabelle ist ein Problem aufgetreten, dies kann bei manchen Hostern vorkommen, da diese Tabelle 78 000 Zeilen enthält. Sie können es erneut versuchen oder ohne diese Tabelle fortfahren. In diesem Fall ist aber keine Übersicht über die Länderherkunft der Crawler verfügbar. Auf der 'Troubleshooting' Seite der Dokumentation auf  www.crawltrack.fr, finden Sie Informationen, wie Sie diese Tabelle manuell füllen können.";
...
$language['attack_block_alert']="Bevor Sie Angriffe blocken, was sicherlich das Beste für Ihre Seitensicherheit ist, schauen Sie sich bitte die Dokumentation auf www.crawltrack.fr an, um sicher zu stellen, dass Ihre normalen Besucher keine Probleme beim Seitenbesuch haben.";
