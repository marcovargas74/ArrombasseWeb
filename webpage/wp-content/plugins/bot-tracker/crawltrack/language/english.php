...
//modified in 1.5.0
$language['login_finish']="Installation is now finish. Don't forget to put the tag (available on tools page <img src=\"./images/wrench.png\" width=\"16\" height=\"16\" border=\"0\" >) on your site pages.";
//access
...
$language['100_visit_per-crawler']="Visits details (display limited to %d lines).";
...
$language['user_suppress_validation']="Are you sure that you want to suppress that account?";
$language['yes']="Yes";
$language['no']="No";
...
$language['site_suppress_validation']="Are you sure that you want to suppress that website?";
...
$language['crawler_suppress_validation']="Are you sure that you want to suppress that crawler?";
...
$language['no_access2']="Link with www.CrawlTrack.fr failed, please try again later.";
...
$language['data_suppress']="Archive the oldest datas of the visits table.";
...
$language['ip_suppress_validation2']="Are you sure that you want to suppress the visits coming from that IP?";
...
$language['data_human_suppress_validation']="Are you sure you want to suppress all &nbsp;";
