<?php
				...
				if($nbr<707)
					...
					(936,'envolk/1.7 (+http://www.envolk.com/envolkspiderinfo.php)','Envolkspider','http://www.envolk.com/envolkspiderinfo.php','Envolk',''), 
                   ...
                   (985,'CydralSpider/2.2 (Cydral Image Search; http://www.cydral.com)','CydralSpider','http://www.cydral.com','Cydral',''),
					...
					(1007,'GurujiBot/1.0 (+http://www.guruji.com/WebmasterFAQ.html)','GurujiBot','http://www.guruji.com/WebmasterFAQ.html','Guruji',''),
				...
				if($table_exist10 == 0)
                    ...
                    if($result12==1)
						{
						$result13 =mysql_query("INSERT INTO crawlt_config (id_config, timeshift, public, mail, datelastmail,addressmail, lang, version, firstdayweek, rowdisplay, orderdisplay, typemail, typecharset) VALUES ('1','0','0','0','0','','".$crawltlang."','221','Monday','30','0','1','1')");
						}
