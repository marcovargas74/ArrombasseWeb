var cincopaGallery = {
	...
	_show: function () {
		...
		jQuery(event.target).parent().addClass('pressed');
		
		var position = jQuery(event.target).offset();
	...
	_show_contents: function (data) {
		...
		var login = '<div class="cincopa-login"><a href="https://www.cincopa.com/login.aspx" target="_blank">Please login first</a></div>';
